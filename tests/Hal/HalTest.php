...
EOD;
    ...
    {
        $x = new Hal\Resource('/', array('x' => array('key' => 'test', 'value' => 'test')));
...
EOD;
    ...
    public function testLinksWithAttributesUnserialiseCorrectlyXml()
    {
        ...
        $this->assertEquals($x->asXml(), Hal\Resource::fromXml($x->asXml())->asXml());
    }
